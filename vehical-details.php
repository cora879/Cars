...
<title>Blue Tree Car Rental Portal | Vehicle Details</title>
<!--Bootstrap -->
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <div class="form-group">Price Per Day
              <input type="number" class="form-control" name="pricePerDay"  id="pricePerDay" Value="<?php echo htmlentities($result->PricePerDay);?>" required>
            </div>
            <!DOCTYPE html>
<html>
<head>
    <title>Date Restriction Example</title>
</head>
<body>
    ...
    <script>
        ...
        // Set the minimum value of both date inputs to the current date
        document.getElementById("fromdate").min = today;
        document.getElementById("todate").min = today;

        // Event listener to ensure 'To Date' is always after 'From Date'
        document.getElementById("fromdate").addEventListener("change", function() {
            ...
            <div class="form-group">
            <button type="button" class="btn btn-primary" onclick="displayTotalPrice()">Calculate Total Price</button>
</div>
...
function calculateTotalPrice() {
    ...
    const days = Math.round(Math.abs((fromDate - toDate) / oneDay));

    if (!isNaN(pricePerDay) && !isNaN(days)) {
        const totalPrice = pricePerDay * days;
        document.getElementById('totalPrice').value = 'Ksh' + totalPrice.toFixed(2);
    } else {
