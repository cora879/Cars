...
<title>Blue Tree Car Rental Portal</title>
<!--Bootstrap -->
...
<img src="j.jpg" width="1600" height="500">
  <div class="container">
    <div class="div_zindex">
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h6>DISCOVER LUXURY AND RELIABILITY.</h6>
            <h6>We have a wide catalogue of cars for you to choose from. </h6>
            <h6>We ensure that you have found the right fit, a car that matches your needs. </h6>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Explore Our Page <span>Find a Car For You</span></h2>
      <p>Blue Tree Car Hire company</p>
      <p>Blue Tree Car Hire company</p>
      <p>Blue Tree Car Hire company</p>
    </div>
    <div class="row"> 
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Blue Tree Car Hire Satisfied <span>Customers</span></h2>
    </div>
    <div class="row">
